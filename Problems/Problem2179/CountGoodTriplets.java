...
//  nums1 and nums2. In other words, if we consider pos1v as the index of the value v in nums1 and pos2v as the
//  index of the value v in nums2, then a good triplet will be a set (x, y, z) where 0 <= x, y, z <= n - 1,
